...
<head>
  ...
  <title>TrafficOFFENSE  | Contact</title>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top" style="background-color: #FFC107;">
    <div class="container d-flex justify-content-between">
      ...
      <div class="d-none d-lg-flex social-links align-items-center">
        <a href="#about" style="color: white;">| About Us |</a> <a href="#" style="color: white;">| Contact |</a> <a onclick="return confirm('Sure to logout?')" href="logout.php" style="color: white;">| Log out |</a>
      </div>
    </div>
  </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>traffioffense.ctg@gmail.com</p>
              </div>
