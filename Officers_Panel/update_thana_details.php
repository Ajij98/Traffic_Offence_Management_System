					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="assets/img/pp.jpg" alt="profile_img" class="img-circle" />
							</figure>
							<div class="profile-info" data-lock-name="" data-lock-email="">
								<span class="name">Tahasin H. Ador</span>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="alert alert-warning">
						...
						<i class="fa fa-check"></i> <strong>Updated!</strong> Data updated successfully.
					</div>
					<!-- start: page -->
						<div class="row">
							<div class="col-lg-12">
									...
									<div class="panel-body">
										...
										<form class="form-horizontal" method="post" enctype="multipart/form-data" autocomplete="off">							
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="Thana" placeholder="Enter thana name" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<textarea class="form-control" rows="4" name="address_details" placeholder="Type thana address details here.." required></textarea>
													</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-group">
														...
														<input type="text" data-plugin-timepicker class="form-control" class="thana_added_time"
														required>
													</div>
												</div>
											</div>
