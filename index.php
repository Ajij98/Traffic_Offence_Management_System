  ...
  <div id="topbar" class="d-flex align-items-center fixed-top" style="background-color: #FFC107;">
    <div class="container d-flex justify-content-between">
      ...
      <div class="d-none d-lg-flex social-links align-items-center">
        <a href="#about" style="color: white;">| About Us |</a> <a href="contact.php" style="color: white;">| Contact |</a> <a href="login.php" style="color: white;">| Log in |</a>
      </div>
    </div>
  </div>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="login.php">MY OFFENSE RECORDS</a></li>
        </ul>
        <i class="bi bi-list mobile-nav-toggle"></i>
      </nav><!-- .navbar -->

      <a href="police_registration.php" class="btn btn-outline-primary btn-sm px-3" style="border-radius: 20px; margin-left: 20px;"><span class="d-none d-md-inline"></span>SIGN UP</a>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="login.php">My Offense Records</a></li>
            </ul>
          </div>
