<?php
 ...
 <?php
     ...
     $read_po = $db->select($sql);
     if($read_po)
     {
       $total_po = $read_po->num_rows;
     }
     else
     {
       $total_po = 0;
    ...
    <!-- Total Traffic Police Count -->
 <?php
     $user_name = $_SESSION['user_name'];
     $db   = new Database();
     $sql  = "SELECT * FROM tb_user WHERE user_type = 'Traffic Police'";
     $read_tf = $db->select($sql);
     if($read_tf)
     {
       $total_tf = $read_tf->num_rows;
     }
     else
     {
       $total_tf = 0;
 ...
 <?php
     ...
     $read_tof = $db->select($sql);
     if($read_tof)
     {
       $total_tof = $read_tof->num_rows;
     }
     else
     {
       $total_tof = 0;
 ...
 <?php
     ...
     $read_tor = $db->select($sql);
     if($read_tor)
     {
       $total_tor = $read_tor->num_rows;
     }
     else
     {
       $total_tor = 0;
...
<html class="fixed">
	<head>
		...
		<title>TrafficOFFENSE  | Admin Dashboard</title>
									...
									<section class="panel panel-featured-left panel-featured-success">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Total Police Officer</h4>
														<div class="info">
															<strong class="amount"><?php echo $total_po; ?></strong>
														</div>
													</div>
													<div class="summary-footer">
														<a href="registered_police.php" class="text-muted text-uppercase">(VIEW ALL)</a>
													</div>
												</div>
											</div>
										</div>
									...
									<section class="panel panel-featured-left panel-featured-quartenary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Total Traffic Police</h4>
														<div class="info">
															<strong class="amount"><?php echo $total_tf; ?></strong>
														</div>
													</div>
													<div class="summary-footer">
														<a href="registered_traffic_police.php" class="text-muted text-uppercase">(VIEW ALL)</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount"><?php echo $total_tof; ?></strong>
														</div>
													</div>
													<div class="summary-footer">
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount"><?php echo $total_tor; ?></strong>
														</div>
													</div>
													<div class="summary-footer">
