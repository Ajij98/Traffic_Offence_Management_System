 ...
 <?php
  ...
  <?php
   ...
   if(isset($_POST['update']))
   {
        ...
        $sql = "UPDATE tb_user SET name='$name',email='$email',phone='$phone',nid='$nid',address='$address',entry_time='$current_datetime' WHERE user_name = '$user_name'";

         $update_row = $db->update($sql);

         if($update_row)
         {
	         $success_msg_1 = '<div class="alert alert-success">
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								<i class="fa fa-check"></i> Profile information updated.
							</div>';
         }
         else
         {
  ...
  <?php
   ...
   if(isset($_POST['change_pass']))
   {
   	if(matchPassword())
   	{
        ...
        $sql = "UPDATE tb_user SET password='$password',entry_time='$current_datetime' WHERE user_name = '$user_name'";

         $update_row = $db->update($sql);

         if($update_row)
         {
	         $success_msg_2 = '<div class="alert alert-success">
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								<i class="fa fa-check"></i> Password changed.
							</div>';
         }
         else
         {
    ...
    if($_POST['password'] !== $_POST['repeat_password'])
    {
        ?>
           <script type="text/javascript">
             window.alert("Warning ! New Password and Repeat password should match.");
           </script>
        <?php
      return false;
    }
...
<html class="fixed">
	<head>
		...
		<title>TrafficOFFENSE  | My Account</title>
				...
				<section role="main" class="content-body">
					...
					<div class="row">
							...
							<section class="panel">
								<div class="panel-body">
									<div class="thumb-info mb-md">
										<img src="assets/img" class="rounded img-responsive" alt="Profile_img">
										<div class="thumb-info-title">
											<span class="thumb-info-inner"><?php echo $name; ?></span>
											<span class="thumb-info-type"><?php echo $user_name; ?></span>
										</div>
									</div>
									...
									<div class="widget-toggle-expand mb-md">
										...
										<div class="widget-content-expanded">
											<ul class="simple-todo-list">
												<li class="completed">Update Profile Information</li>
												<li class="completed">Change Password</li>
											</ul>
										</div>
									</div>
						...
						<div class="col-md-8 col-lg-8">
							...
							<?php echo $success_msg_1; ?>

							<?php echo $success_msg_2; ?>
							...
							<div class="tabs">
								<ul class="nav nav-tabs tabs-primary">
									...
									<li>
										<a href="#overview" data-toggle="tab">Change Password</a>
									</li>
								</ul>
										...
										<form action="" class="form-horizontal" method="post">
											...
											<fieldset>
												...
												<div class="form-group">
													...
													<div class="col-md-8">
														<input type="number" class="form-control" name="nid" id="nid" value="<?php echo $nid; ?>" required>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<label class="col-md-3 control-label" for="old_password">Password</label>
													<div class="col-md-8">
														<input type="text" class="form-control" name="old_password" id="old_password" value="<?php echo $password; ?>" readonly>
													</div>
												</div>
											</fieldset>
									...
									<div id="overview" class="tab-pane">
										<form action="" class="form-horizontal" method="post">
											...
											<fieldset class="mb-xl">
												...
												<div class="form-group">
													<label class="col-md-3 control-label" for="repeat_password">Repeat New Password</label>
													<div class="col-md-8">
														<input type="text" class="form-control" name="repeat_password" id="repeat_password" required>
													</div>
												</div>
											</fieldset>
											<div class="panel-footer">
