<?php
 ...
 <?php
   ...
   {
   		 $offense_code        = rand(100000, 999999);
         ...
         $sql = "INSERT INTO tb_offense(offense_code,offense_name,offense_description,offense_fine,offense_added_on,offense_added_time,added_by,entry_time)values('$offense_code','$offense_name','$offense_description','$offense_fine','$offense_added_on','$offense_added_time','$added_by','$current_datetime')";
         ...
         if($insert_row)
         {
           $success_msg = '<div class="alert alert-success">
								...
								<i class="fa fa-check"></i> <strong>Success.</strong> Offense details saved.
							</div>';
         }
         else 
         {
...
<html class="fixed">
	<head>
		...
		<title>TrafficOFFENSE  - Add Offense</title>
									...
									<div class="panel-body">
										...
										<form class="form-horizontal" method="post" enctype="multipart/form-data" autocomplete="off">							
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" name="offense_name" placeholder="Enter traffice offense name" required>
												</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<textarea class="form-control" rows="4" name="offense_description" placeholder="Type offense description here.." required></textarea>
													</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="number" class="form-control" name="offense_fine" placeholder="Enter fine" required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-group">
														...
														<input type="text" data-plugin-datepicker class="form-control" name="offense_added_on" required>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-group">
														...
														<input type="text" data-plugin-timepicker class="form-control" name="offense_added_time"
														required>
													</div>
												</div>
											</div>
											...
											<div class="text-center">
												<input  type="submit" id="shadow-success" class="btn btn-primary" name="submit" value="Add Offense">

												<a href="add_offense.php" type="button" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-refresh"></i> Refresh</a>
											</div>
