<?php
 ...
 <?php
   ...
   if(isset($_POST['submit']))
   {
         ...
         $sql = "INSERT INTO tb_thana(thana_code,thana_area,thana_name,thana_contact,thana_address_details,area_gmap_link,thana_added_on,thana_added_time,added_by,entry_time)values('$thana_code','$thana_area','$thana_name','$thana_contact','$thana_address_details','$area_gmap_link','$thana_added_on','$thana_added_time','$added_by','$current_datetime')";
         ...
         if($insert_row)
         {
           $success_msg = '<div class="alert alert-success">
								...
								<i class="fa fa-check"></i> <strong>Success.</strong> Thana details saved.
							</div>';
         }
         else 
         {
...
<html class="fixed">
	<head>
		...
		<title>TrafficOFFENSE  - Add Thana</title>
									...
									<div class="panel-body">
										...
										<form class="form-horizontal" method="post" enctype="multipart/form-data" autocomplete="off">							
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="thana_area">* Area</label>
												<div class="col-md-6">
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="thana_name">* Thana Name :</label>
												<div class="col-md-6">
													<input type="text" class="form-control" name="thana_name" placeholder="Enter thana name" required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6 control-label">
													<div class="input-group">
														...
														<input id="phone" data-plugin-masked-input data-input-mask="99999-999999" name="thana_contact" placeholder="Enter thana contact" class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<textarea class="form-control" rows="4" name="thana_address_details" placeholder="Type thana address details here.." required></textarea>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<textarea class="form-control" rows="4" name="area_gmap_link" placeholder="Put thana google map link here.." required></textarea>
													</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-group">
														...
														<input type="text" data-plugin-datepicker class="form-control" name="thana_added_on" required>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-group">
														...
														<input type="text" data-plugin-timepicker class="form-control" name="thana_added_time"
														required>
													</div>
												</div>
											</div>
											...
											<div class="text-center">
												<input  type="submit" id="shadow-success" class="btn btn-primary" name="submit" value="Add Thana">

												<a href="add_thana.php" type="button" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-refresh"></i> Refresh</a>
											</div>
