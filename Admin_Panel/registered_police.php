<?php
 ...
 <!-- Registered Police table data load -->
 <?php
   $user_name   = $_SESSION['user_name'];
   $db          = new Database();
   $sql         = "SELECT * FROM tb_user WHERE user_type = 'Police Officer'";
   $read_police = $db->select($sql);
  ?>
...
<html class="fixed">
	<head>
		...
		<title>TrafficOFFENSE  - Police List</title>
							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Police List</h2>
									</header>
									...
									<div class="panel-body">
										...
										<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											...
											<tbody>
												...
												<?php if($read_police){ $i = 0; ?>
                            					<?php while($result = $read_police->fetch_assoc()){ $i = $i + 1; ?>
												<tr>
