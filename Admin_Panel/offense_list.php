...
<html class="fixed">
	<head>
		...
		<title>TrafficOFFENSE  - Offense List</title>
							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Offense List</h2>
									</header>

									<div class="panel-body">

										<a href="add_offense.php" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add New Offense</a>
										...
										<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											...
											<tbody>
												...
												<tr>
													<td class="text-primary"><?php echo '[OID-'.$result['offense_id'].']'; ?></td>
													<td><?php echo '[OC-'.$result['offense_code'].']'; ?></td>
													<th class="text-primary"><?php echo $result['offense_name']; ?></th>
													<td><?php echo $result['offense_description']; ?></td>
													<td><?php echo $result['offense_fine']. 'Tk.'; ?></td>
													<td><?php echo date("F j, Y", strtotime($result['offense_added_on'])) ?> | <?php echo $result['offense_added_time']; ?></td>
													<td><a href="update_offense_details.php?offense_id=<?php echo $result['offense_id']; ?>" title="update" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i></a> <a href="delete_data.php?offense_id=<?php echo $result['offense_id']; ?>" onclick="return confirm('Sure to delete?')" title="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td>
												</tr>
												<?php } ?>
					                            <?php }else{ ?>
