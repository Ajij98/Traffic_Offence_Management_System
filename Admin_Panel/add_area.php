<?php
 ...
 <?php
   ...
   if(isset($_POST['submit']))
   {
         ...
         $sql = "INSERT INTO tb_area(area_name,area_gmap_link,added_by,entry_time)values('$area_name','$area_gmap_link','$added_by','$current_datetime')";
         ...
         if($insert_row)
         {
           $success_msg = '<div class="alert alert-success">
								...
								<i class="fa fa-check"></i> <strong>Success.</strong> Area details saved.
							</div>';
         }
         else 
         {
...
<html class="fixed">
	<head>
		...
		<title>TrafficOFFENSE  - Add Area</title>
									...
									<div class="panel-body">
										...
										<form class="form-horizontal" method="post" enctype="multipart/form-data" autocomplete="off">							
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<textarea class="form-control" rows="4" name="area_gmap_link" placeholder="Put area google map link here.." required></textarea>
													</div>
											</div>

											<div class="text-center">
												<input  type="submit" id="shadow-success" class="btn btn-primary" name="submit" value="Add Area">

												<a href="add_area.php" type="button" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-refresh"></i> Refresh</a>
											</div>
									...
									<div class="panel-body">
										<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											...
											<tbody>
												...
												<tr>
													<td class="text-primary"><?php echo '[AID-'.$result['area_id'].']'; ?></td>
													<td><?php echo $result['area_name']; ?></td>
													<td><a href="<?php echo $result['area_gmap_link']; ?>" target="_blank" class="btn btn-dark btn-sm"><i class="fa fa-map-marker"></i> View</a></td>
													<td><a href="update_area_details.php?area_id=<?php echo $result['area_id']; ?>" title="update" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i></a> <a href="delete_data.php?area_id=<?php echo $result['area_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td>
												</tr>
												<?php } ?>
					                            <?php }else{ ?>
