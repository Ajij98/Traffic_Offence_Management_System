<?php
 ...
 <?php
   ...
   $db         = new Database();
   $sql        = "SELECT * FROM tb_offense_record";
...
<html class="fixed">
	<head>
		...
		<title>TrafficOFFENSE  - Offense Record List</title>
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Offense Record List</span></li>
							</ol>
							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Offense Record List</h2>
									</header>
										...
										<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											<thead>
												<tr>
													...
													<th>Offense Record Date & Time</th>
													<th>Record Verify Status</th>
													<th>Verify Record</th>
													<th>View Record File</th>
													<th>Action</th>
												</tr>
											</thead>
											<tbody>
												...
												<tr>
													...
													<td>[<a href="offense_record_file.php?offense_record_id=<?php echo $result['offense_record_id']; ?>"><?php echo $result['ticket_no']; ?></a>]</td>
													...
													<td>
				                                        <?php
				                                            $record_verify_status = $result['record_verify_status'];

				                                            if($record_verify_status == 1)
				                                            {
				                                                $msg = '<span class="label label-success">Verified</span>';
				                                                    echo $msg;
				                                            }
				                                            else
				                                            {
				                                                $msg = '<span class="label label-warning">Pending..</span>';
				                                                    echo $msg;
				                                            }
				                                        ?>
				                                    </td>
				                                    <td>
														...
														<?php
				                                            ...
				                                            {
				                                              ?>
				                                                <button type="button" class="btn btn-success btn-sm" name="button" disabled><i class="fa fa-check"></i> Verified</button>
				                                              <?php
				                                            }
				                                            else
				                                            {
				                                              ?>
				                                              <a href="offense_record_verification.php?offense_record_id=<?php echo $result['offense_record_id']; ?>" class="btn btn-success btn-sm" onclick="return confirm('Sure to verify record?')">Verify Record</a>
				                                              <?php
				                                            }
				                                          ?>
													</td>
													<td><a href="offense_record_file.php?offense_record_id=<?php echo $result['offense_record_id']; ?>" title="view record file" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View</a></td>
													<td><a href="delete_data.php?offense_record_id=<?php echo $result['offense_record_id']; ?>" onclick="return confirm('Sure to delete?')" title="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td>
												</tr>
												<?php } ?>
					                            <?php }else{ ?>
